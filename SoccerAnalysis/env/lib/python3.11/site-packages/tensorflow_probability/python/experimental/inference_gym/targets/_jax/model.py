...
from tensorflow_probability.python.experimental.inference_gym.internal._jax import ground_truth_encoding
...
_GROUND_TRUTH_MODULE_PATTERN = (
    ...
    'tensorflow_probability.python.experimental.inference_gym.targets.ground_truth._jax.{}'
)
